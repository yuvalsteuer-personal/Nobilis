...
public:
	...
	static std::vector<Object*> toList(std::string& str);

	static void toList(std::string str, bool IS_LIST, bool IS_STRING, std::vector<Object*>& vec, char dl);

	// check if the parameter is a valid List value.
	static bool isList(std::string str, bool IS_LIST, bool IS_STRING, std::vector<Object*>& vec, char dl);
