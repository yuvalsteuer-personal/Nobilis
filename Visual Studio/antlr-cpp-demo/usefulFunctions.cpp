...
std::vector<Object*> Useful::toList(std::string & str)
{
...
void Useful::toList(std::string str, bool IS_LIST, bool IS_STRING, std::vector<Object*>& vec, char dl)
{
...
bool Useful::isList(std::string str, bool IS_LIST, bool IS_STRING, std::vector<Object*>& vec, char dl)
{
